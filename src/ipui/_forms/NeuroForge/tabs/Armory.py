...
from ipui import parse_int_list
...
class EZ_Pane(_BaseTab):
    ...
    def ip_activated(self, ip):
        if not hasattr(self, 'private_first_visit'):
            self.private_first_visit = True
            #self.form.set_pane(2, lambda p: self.pane_config_detail(p, "Optimizer"))
            self.form.set_pane(2, self.pane_config_detail, "Optimizer")
    ...
    def build_settings_left(self, parent: Row) -> None:
        ...
        col  = CardCol(parent, flex_width=1)
        form = self.form
    ...
    def build_settings_right(self, parent: Row) -> None:
        ...
        col  = CardCol(parent, flex_width=1, flex_height=1)
        form = self.form
    ...
    def build_settings_below(self, parent) -> None:
        ...
        form = self.form
        sub  = CardCol(parent, flex_height=1)
    ...
    def rng_data(self, parent) -> None:
        ...
        btn_clear = Button(row_manual, "Clear", color_bg=Style.COLOR_BUTTON_DANGER)
    ...
    def pane_config_detail(self, parent, category_name: str = "Optimizer") -> None:
        ...
        #col_right = CardCol(row, flex_width=1, flex_height=1)
    ...
    def build_list_hyperparam(self, parent, name: str, meta: dict) -> None:
        ...
        btn_clear = Button(header_row, "Clear", color_bg=Style.COLOR_BUTTON_DANGER)
