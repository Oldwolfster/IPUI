class _SchemaFlds:
    ...
    TRACKS = [
        ...
        (20260628, 'perm', 'forest_batter'),
        (20260628, 'perm', 'forest_pa'),
        (20260629, 'perm', 'forest_pa_all2'),
        (20260629, 'perm', 'predict_forest_batter'),
        (20260629, 'perm', 'predict_forest_pa'),
        (20260629, 'perm', 'predict_forest_pa_all2'),
        (20260629, 'perm', 'raw_pitches'),
        ...
        (20260629, 'trueDmg', 'predict_forest_pa_dmg'),
        (20260629, 'trueDmg', 'raw_pitches'),
