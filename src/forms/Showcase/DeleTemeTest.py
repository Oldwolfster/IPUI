...
class TemplateShowcase(_basePane):
    ...
    def test4(self, parent):
        Body(parent, 'Method: test4')
        Body(parent, 'Add content here!')

    def test45(self, parent):
        Body(parent, 'Method: test45')
        Body(parent, 'Add content here!')

    def test46(self, parent):
        Body(parent, 'Method: test46')
        Body(parent, 'Add content here!')

    def test47(self, parent):
        Body(parent, 'Method: test47')
        Body(parent, 'Add content here!')
